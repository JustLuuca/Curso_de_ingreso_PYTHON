...
class App(customtkinter.CTk):
    ...
    def btn_sumar_on_click(self):
        ...
        mensaje = "El resultado de la suma es: " + format(resultado)
    ...
    def btn_restar_on_click(self):
        ...
        resultado = operador_a_numero - operador_b_numero
        mensaje = "El resultado de la resta es: " + format(resultado)
    ...
    def btn_multiplicar_on_click(self):
        ...
        mensaje = "El resultado de la multiplicacion es: " + format(resultado)
    ...
    def btn_dividir_on_click(self):
        ...
        mensaje = "El resto es: " + format(resultado)
